...
pub fn planning_mode_turn(cwd: &str, roadmap: &str, request: &str, plan: &str, architecture: &str, active_task: &str, history: &str) -> String {
    ARCHITECT_TEMPLATE
        .replace("{{CWD}}", cwd)
...
pub fn execution_mode_turn(cwd: &str, roadmap: &str, request: &str, plan: &str, architecture: &str, _active_task: &str, history: &str) -> String {
    DEVELOPER_TEMPLATE
        .replace("{{CWD}}", cwd)
        .replace("{{ROADMAP}}", roadmap)
        .replace("{{ARCHITECTURE}}", architecture)
